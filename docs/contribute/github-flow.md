...
<!-- Title: Contributing GithubFlow AnsibleRoleTemplate -->
...
To contribute to ansible-role-template project on [GitHub](https://github.com/hadenlabs/ansible-role-template), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/ansible-role-template/pulls).
...
To follow the instructions in this guide and start contributing to ansible-role-template project on GitHub:
...
```bash
git remote add upstream  https://github.com/hadenlabs/ansible-role-template.git
```

Now your **upstream** points to **hadenlabs/ansible-role-template**.
...
git fetch upstream # assuming upstream is hadenlabs/ansible-role-template
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/ansible-role-template/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
